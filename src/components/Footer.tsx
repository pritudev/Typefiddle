...
export default class Footer extends Component {
	render() {
      ...
      <a target="_blank" rel="noreferrer" href="https://github.com/pritudev/typingfiddle"><button type="button" className="btn mb-2">
          <svg className="mb-2" xmlns="http://www.w3.org/2000/svg" width="auto" height="20" fill="#646669" viewBox="0 0 16 16">
            <path d="M10.478 1.647a.5.5 0 1 0-.956-.294l-4 13a.5.5 0 0 0 .956.294l4-13zM4.854 4.146a.5.5 0 0 1 0 .708L1.707 8l3.147 3.146a.5.5 0 0 1-.708.708l-3.5-3.5a.5.5 0 0 1 0-.708l3.5-3.5a.5.5 0 0 1 .708 0zm6.292 0a.5.5 0 0 0 0 .708L14.293 8l-3.147 3.146a.5.5 0 0 0 .708.708l3.5-3.5a.5.5 0 0 0 0-.708l-3.5-3.5a.5.5 0 0 0-.708 0z"></path>
          </svg>
          <h4>GITHUB</h4>
        </button></a>
      <a target="_blank" rel="noreferrer" href="https://discord.gg/DpdGS4XsXF"><button type="button" className="btn mb-2">
          <svg className="mb-2" xmlns="http://www.w3.org/2000/svg" width="auto" height="20" fill="#646669" viewBox="0 0 16 16">
